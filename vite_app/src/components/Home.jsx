  ...
  return (
    <div className="main">
      ...
      <div className="artist-img-home">
        <div className="eric">
          <img className="eric-1" src="https://res.cloudinary.com/dnbayngfx/image/upload/v1738815718/th_id_OIP_12_nlojdd.png" alt="Eric" />
        </div>

        <div className="parth-1">
          <img className="eric-1" src="https://res.cloudinary.com/dnbayngfx/image/upload/v1738780221/par-1_1_n107sg.png" alt="Parth" />
        </div>

        <div className="poufa">
          <img className="eric-2" src="https://res.cloudinary.com/dnbayngfx/image/upload/v1738815384/IMG_3884_1_n7nhl2.png" alt="Poufa" />
        </div>
      </div>
      ...
      <div className="artist-portfolio">
        <Link className="portfolio" to="./components/Ourartist/Eric">
        ...
        <Link className="portfolio-1" to="./components/Ourartist/Parth">
          <h3 className="portfolio-text">PORTFOLIO</h3>
          <svg className="p-icon" width="" height="16" viewBox="0 0 26 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M25.7071 8.70711C26.0976 8.31658 26.0976 7.68342 25.7071 7.29289L19.3431 0.928932C18.9526 0.538408 18.3195 0.538408 17.9289 0.928932C17.5384 1.31946 17.5384 1.95262 17.9289 2.34315L23.5858 8L17.9289 13.6569C17.5384 14.0474 17.5384 14.6805 17.9289 15.0711C18.3195 15.4616 18.9526 15.4616 19.3431 15.0711L25.7071 8.70711ZM0 9H25V7H0V9Z" fill="black" />
          </svg>
        ...
        <Link className="portfolio-2" to="./components/Ourartist/Poufa">
          <h3 className="portfolio-text">PORTFOLIO</h3>
          <svg className="p-icon" width="" height="16" viewBox="0 0 26 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M25.7071 8.70711C26.0976 8.31658 26.0976 7.68342 25.7071 7.29289L19.3431 0.928932C18.9526 0.538408 18.3195 0.538408 17.9289 0.928932C17.5384 1.31946 17.5384 1.95262 17.9289 2.34315L23.5858 8L17.9289 13.6569C17.5384 14.0474 17.5384 14.6805 17.9289 15.0711C18.3195 15.4616 18.9526 15.4616 19.3431 15.0711L25.7071 8.70711ZM0 9H25V7H0V9Z" fill="black" />
          </svg>
      ...
      <div className="self-journey">
        <p className="self-1">
          Embark on a self-expression journey at tattoo Dreamers Studio. Our tattoos go
          ...
          is a declaration to your journey and an endless source of inspiration.
        </p>
      </div>
      ...
      <div className="bg-white">
        ...
        <p className="home-talk1">
          Nervous or excited? We've got you!
          Let's talk and create the perfect tattoo for you.
        </p>
